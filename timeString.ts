class timeString {
    ...
    //***********************************************************************/
        ...
        // timeString.fromMinutes returns a zero-padded string (HH:MM:SS) given time in minutes
        {
    ...
    // minutes and appends short date if time is > 24 or < 0, resp.
        ...
        static shortAMPM(minutes: number, JD: number)
        {
            var julianday = JD;
            var floatHour = minutes / 60.0;
            var hour = Math.floor(floatHour);
            ...
            if (daychange) return timeStr + " " + timeString.dayFromJD(julianday);
            return timeStr;
        }
    ...
    // in minutes and julian day, and appends the short date
        ...
        static AMPMDate(minutes: number, JD: number)
        {
            var julianday = JD;
            var floatHour = minutes / 60.0;
            var hour = Math.floor(floatHour);
    ...
    // and julian day, and appends the short date if time crosses a day boundary
        ...
        static appendDate(minutes: number, JD: number)
        {
            var julianday = JD;
            var floatHour = minutes / 60.0;
            var hour = Math.floor(floatHour);
